...
- Separate 8% Dubai holding company scenario where Jason owns 87%, Adam owns 5%, and the holding company funds the U.S. C corp through a mix of preferred equity and documented debt.
- Debt/preferred scenario variables including holding company cash infusion, debt percentage, fixed interest rate, preferred return, participating preferred residual share, loan term, months outstanding, amortization style, interest withholding, dividend withholding, UAE corporate tax, and Section 163(j)-style interest limitation.
- Development project economics for the debt scenario, including land acquisition price, land additions/site work, building/development costs, soft costs, permits/legal/admin, contingency, carrying costs, profit-target/manual-sale-proceeds modes, and the resulting operating profit before interest.
